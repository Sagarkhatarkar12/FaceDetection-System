...
cap.set(3, 640)
cap.set(4, 480)
print("Starting web came")
modeType, counter, current_id = 0, 0, None
# here we will give the window size 
while True:
    ret, frame = cap.read()
    if not ret :
...
#     cv2.imshow("Live Camera", frame)        # draw the frame
